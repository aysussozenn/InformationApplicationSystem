...
public class BasvuruBilgiBelgeView implements ViewInterface {
	...
	//BasvuruBilgiBelgeModel'deki cevaba bilgi veya belge eklenebilmesi için gerekli olan insert'ün operation'ý
	...
	ViewData insert1GUI(ModelData modelData) throws Exception {
		...
		String bilgi;
			...
			bilgiMi = getBoolean("Bilgi Mi", true);
		...
		//Kullanýcýnýn girdiði bilgilere göre BasvuruBilgiBelge objesi oluþturulmasý.
